export const OFFICER_CONFIG = [
  {
    ...
    nameKey: 'ceoName',
    noteKey: 'ceoNote',
    responseKey: 'ceoResponse',
    responseByKey: 'ceoResponseBy',
    titleKey: 'ceoTitle',
  ...
  },
  {
    ...
    nameKey: 'hodName',
    noteKey: 'hodNote',
    responseKey: 'hodResponse',
    responseByKey: 'hodResponseBy',
    titleKey: 'hodTitle',
  ...
  },
  {
    ...
    nameKey: 'deanName',
    noteKey: 'deanNote',
    responseKey: 'deanResponse',
    responseByKey: 'deanResponseBy',
    titleKey: 'deanTitle',
